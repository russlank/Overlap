...
#ifndef _OVERLAP_CORE
#define _OVERLAP_CORE

#define SUBNET_TITLE_MAX_LENGTH		30
#define MAX_SUBNETS					2048

typedef struct tagSUBNETINFO {
	unsigned int Address;
	unsigned int Mask;
	unsigned int MaskLength;
	char Title[SUBNET_TITLE_MAX_LENGTH];
	//tagSUBNETINFO *next;
} SUBNETINFO;

//typedef SUBNETINFO *pSUBNETINFO;

extern int SubnetsCount;
extern SUBNETINFO Subnets[];
